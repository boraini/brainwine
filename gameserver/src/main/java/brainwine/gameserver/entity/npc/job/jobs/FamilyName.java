...
public class FamilyName extends DialoguerJob {
    ...
    public List<DialogSection> getMainDialogSection(Npc me, Player player) {
        ...
        if(player != null) player.setFamilyName(familyName);
        return Arrays.asList(new DialogSection().setText("Ah, another survivor. I can see you're still a little dazed from that whole apocalypse business... " +
